			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
						<h1 class="h3 text-purple-600 mb-3"><strong>Daftar</strong> Ubah Banner</h1>
                                ...
                                <div class="me-1">
                                    <?php if (isset($_SESSION['message_banner'])) : ?>
                                        <div style="border : 1px solid #EFAE93; background-color: #EFAE93; border-radius: 5px;" align="center;">
                                            <label class="form-label" style="padding-top: 10px; padding-right:10px; padding-left:10px; color: white;"><?php echo $_SESSION['message_banner']; ?></label>
                                        </div>
