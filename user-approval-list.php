			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
						<h1 class="h3 text-purple-600 mb-3"><strong>Daftar</strong> Persetujuan Akun</h1>
                        <div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive pb-4 mb-4" id="table-scroll">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php include 'action/action_user_approval_list.php' ?>
                                        ...
                                        <?php foreach ($dataUsers as $row): ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <a href="user-detail-approval.php?id=<?=$row['id']?>" class="btn btn-primary">Detail</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php $no++;?>
